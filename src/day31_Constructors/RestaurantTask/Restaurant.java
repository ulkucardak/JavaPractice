...
public class Restaurant {
    ...
    public void terminateChef(int emploID){
        chefs.removeIf(p-> p.employeeID == emploID);
    }

    public void terminateServer(int emploID){
        servers.removeIf(p-> p.employeeID == emploID);
    }
