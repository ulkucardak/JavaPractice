...
public class Candy {
    ...
    private boolean hasPeaunuts;


    public Candy(String brand, int quantity, double price, boolean hasPeaunuts) {
        setBrand(brand);
        setPrice(price);
        setQuantity(quantity);
        setHasPeaunuts(hasPeaunuts);
    }
    ...
    public boolean isHasPeaunuts() {
        return hasPeaunuts;
    }

    public void setHasPeaunuts(boolean hasPeaunuts) {
        this.hasPeaunuts = hasPeaunuts;
    }
